...
- **Secure PIN Access**: Access to POS functions often requires a secure PIN entry (`scripts/setup_admin_pin.py`). Critical actions require a manager override PIN.
