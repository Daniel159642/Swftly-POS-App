...
def build_pos_payload_from_shopify_order(
    ...
    """
    from src.core.database import get_or_create_product_for_shopify
...
def sync_shopify_products(establishment_id: int) -> Dict[str, Any]:
    ...
    """
    from src.core.database import get_integrations, get_or_create_product_for_shopify, upsert_integration
    ...
    from src.core.database import get_product_id_by_sku
