...
def get_valid_square_access_token(
    ...
    """
    from src.core.database import get_establishment_settings, update_establishment_settings
...
def run_migration(
    ...
    """
    from src.core.database import add_product, add_employee, create_order, get_connection
